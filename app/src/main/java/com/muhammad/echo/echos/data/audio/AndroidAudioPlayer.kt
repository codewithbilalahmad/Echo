package com.muhammad.echo.echos.data.audio

import android.media.MediaPlayer
import com.muhammad.echo.echos.domain.audio.AudioPlayer
import com.muhammad.echo.echos.domain.audio.AudioTrack
...
class AndroidAudioPlayer(private val applicationScope: CoroutineScope) : AudioPlayer {
    ...
    override fun stop() {
        _activeTrack.update { it?.copy(isPlaying = false, durationPlayed = Duration.ZERO) }
        durationJob?.cancel()
        mediaPlayer?.apply {
            stop()
            reset()
